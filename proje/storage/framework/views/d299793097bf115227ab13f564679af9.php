        ...
        <div class="row p-md-5 min-vw-50 ">
            <div class="col col-sm-auto ">
                <div class="card custom-card" >
                    <a href="/hizliof" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col  col-sm-auto">
                <div class="card custom-card mt-auto" >
                    <a href="/galaksi" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/aksiyon.blade.php ENDPATH**/ ?>