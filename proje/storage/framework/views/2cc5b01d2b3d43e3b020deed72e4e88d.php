...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/resmi-yarisma-.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">RESMİ YARIŞMA</h1>
                    <h6 class="card-text">15 Mayıs 2023 Pazartesi</h6>
                    <h6 class="card-text">Yönetmen: Gastón Duprat, Mariano Cohn</h6>
                    <h6 class="card-text">Oyuncular: Penélope Cruz, Antonio Banderas, Oscar Martínez</h6>
                    <h6 class="card-text">Süre:140 dakika</h6>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">Resmi Yarışma, iyi bir film yapabilmek için ünlü bir film yapımcısı ile anlaşan zengin bir iş adamının hikayesini konu ediyor. Filmde, milyarder girişimci tarafından işe alınan ünlü film yapımcısı Lola Cuevas'a Penélope Cruz hayat verirken, Antonio Banderas ünlü oyuncu Félix Rivero karakterini canlandırıyor. Mariano Cohn ve Gastón Duprat'ın yönetmen koltuğunda oturduğu filmin kadrosunda ayrıca José Luis Gómez, Carlos Hiplito, Irene Escolar, Koldo Olabarri, Nagore Aramburu gibi isimler yer alıyor.</h5>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/resmi-yarisma.blade.php ENDPATH**/ ?>