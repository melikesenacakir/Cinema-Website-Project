...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/hizliveofkeli10.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">HIZLI VE ÖFKELİ 10</h1>
                    <h6 class="card-text">19 Mayıs 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: Louis Leterrier</h6>
                    <h6 class="card-text">Oyuncular: Vin Diesel, Michelle Rodriguez</h6>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">Hızlı ve Öfkeli 10, Dom Torretto’dan intikam almak için onu sevdiklerini hedef alan bir kötüye karşı zorlu bir mücadeleye girişen Dom ve ekibinin hikayesini konu ediyor. Yıllarca karşılarına çıkan onca düşmanı zekice, hızlı sürüşleriyle arkalarında bırakan Dom Toretto ve ailesi, bu defa bu zamana kadarki en ölümcül rakipleriyle karşı karşıyadır. Geçmişten gelen bu tehlikeli düşmanın en büyük amacı Dom Toretto’dan intikam akmaktır. Bu amaçla da gözünü Dom’un sevdiklerine diker ve onları sonsuza dek yok etmek için harekete geçer.</h5>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/hizliveofkeli10.blade.php ENDPATH**/ ?>