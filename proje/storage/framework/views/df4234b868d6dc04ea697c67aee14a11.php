...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/neseliciftliktrenkalkiyor.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">NEŞELİ ÇİFTLİK:TREN KALKIYOR</h1>
                    <h6 class="card-text">12 Mayıs 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: Will Ashurt</h6>
                    <h6 class="card-text">Süre:70 dakika</h6>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">Ekinlerin bir türlü büyümemesi Neşeli Çiftlik'te büyük bir kriz yaşanmasına neden olur. Mucit Albert'in devrimsel icasaı nano-tohum sayesinde bu sorun çözülür. Bunun ardından Albert, buluşunu sergilemek ister. Ancak bu sırada paha biçilemez tohumu çalınır. Hırsızın bir an önce bulunmasını isteyen Klara ve Gaute, çareyi ünlü dedektif Agatha Christensen’den yardım istemekte bulur. Agatha Christensen'in takımına katılan Klara ve Gaute, Neşeli Çiftlik'in geşeceğini kurtarmak için zorlu bir maceraya atılır.</h5>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/neseliciftliktrenkalkiyor.blade.php ENDPATH**/ ?>