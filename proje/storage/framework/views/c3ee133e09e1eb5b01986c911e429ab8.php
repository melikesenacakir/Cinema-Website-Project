...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/kotu-ruh-uyanis.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">KÖTÜ RUH:UYANIŞ</h1>
                    <h6 class="card-text">21 Nisan 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: Lee Coronin</h6>
                    <h6 class="card-text">Oyuncular: Lily Sullivan, Alyssa Sutherland</h6>
                    <h6 class="card-text">Süre:97 dakika</h6>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/kotu-ruh-uyanis.blade.php ENDPATH**/ ?>