        ...
        <div class="row">
            ...
            <div class="col-md-6 d-flex justify-content-center align-items-center bg-light rounded">
               <div class="w-75">
                   ...
                   <p>Kullanıcı giriş panelidir</p>
                   <form action="">
                       <?php echo csrf_field(); ?>
                       <a href="/admin" class="btn btn-outline-success mt-2 mb-2">Admin girişi</a>
                       <a href="/login" class="btn btn-outline-success mt-2 mb-2">Kullanıcı girişi</a>
                       ...
                       <div class="form-floating">
                           ...
                           <p>Henüz hesabınız yok mu?<a href="/kayit" class="link-underline-primary link-dark">Kayıt ol</a></p>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/login.blade.php ENDPATH**/ ?>