...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/dali-diyari.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">DALİ DİYARI</h1>
                    <h6 class="card-text">2 Haziran 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: Mary Harron</h6>
                    <h6 class="card-text">Oyuncular: Ben Kingsley, Barbara Sukowa, Ezra Miller</h6>
                    <h6 class="card-text">Süre:94 dakika</h6>
                    ...
                    <a href="#"><i class="fa fa-twitter mx-md-1"></i><img style="background-color: white" class="rounded-5" src="/Resimler/16.png" width="20" height="20"></a>
                </div>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">Dali Diyarı, büyük sergisine hazırlanan Savador Dali ve ona yardım eden genç asistanının hikayesini konu ediyor. Artık yaşlanmaya başlayan Salvador Dali, New York’ta yeni, büyük bir sergi hazırlığındadır. Genç bir galeri asistanı, büyük sergiye hazırlanma sürecinde Dali’ye yardım eder. Ancak genç asistan, sahne arkasında kendisini büyük bir maceranın içerisinde bulur.</h5>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/dali-diyari.blade.php ENDPATH**/ ?>