...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/askin-bununla-ne-ilgisi-var-.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">AŞKIN BUNUNLA NE İLGİSİ VAR?</h1>
                    <h6 class="card-text">19 Mayıs 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: Shekhar Kapur</h6>
                    <h6 class="card-text">Oyuncular: Mim Shaikh, Lily James, Emma Thompson</h6>
                    <h6 class="card-text">Süre:108 dakika</h6>
                    ...
                    <a href="#"><i class="fa fa-twitter mx-md-1"></i><img style="background-color: white" class="rounded-5" src="/Resimler/10.png" width="20" height="20"></a>
                    <a href="#"><i class="fa fa-facebook mx-md-1"></i><img style="background-color: white" class="rounded-5" src="/Resimler/13a.png" width="20" height="20"></a>
                </div>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">Flört uygulamalarına bağımlı bir belgesel yapımcısı olan Zoe, riskli buluşmalarını biraz eksantrik olan annesi Cath'in bu duruma dehşetle yaklaşmasına rağmen giderek çoğaltır. Zoe'nin çocukluk arkadaşı ve komşusu Kaz'ın ise böyle sorunları yoktur. Kaz’ı Pakistanlı güzel bir gelinle evlendirmek isteyen ailesi, partner seçimini devralır. Zoe, Kaz’ın tamamen yabancı biriyle evlenmek için Londra'ya yaptığı yolculuğunu filme alırken, aşkı bulmaya yönelik bu farklı yaklaşımdan bir şeyler öğrenip öğrenemeyeceğini merak etmeye başlar.</h5>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/askin-bununla-ne-ilgisi-var.blade.php ENDPATH**/ ?>