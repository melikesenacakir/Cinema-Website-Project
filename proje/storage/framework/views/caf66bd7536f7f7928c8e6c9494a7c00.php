...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/karanlikgece.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">KARANLIK GECE</h1>
                    <h6 class="card-text">28 Nisan 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: Özcan Alper</h6>
                    <h6 class="card-text">Oyuncular: Berkay Ateş,Pınar Deniz, Ozan Çelik</h6>
                    <h6 class="card-text">Süre:114 dakika</h6>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">7 yıl önce parçası olduğu bir linç olayı, ölmek üzere olan annesine veda etmek için kasabasına döndüğünde peşini bırakmaz. Çocukluk arkadaşları olan diğer beş faille ve onları destekleyen kasaba halkı ile yüzleşen İshak, üzerine çöken suçluluk duygusuyla mücadele eder.</h5>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/karanlikgece.blade.php ENDPATH**/ ?>