...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/kurak-gunler-.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">KURAK GÜNLER</h1>
                    <h6 class="card-text">9 Mart 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: Emin Alper</h6>
                    <h6 class="card-text">Oyuncular: Selahattin Paşalı, Ekin Koç</h6>
                    <h6 class="card-text">Süre:129 dakika</h6>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">Genç bir başsavcı olan Emre (Selahattin Paşalı), küçük Balkaya kasabasına yeni atanır. Kendini büyük bir ciddiyetle işine verir ve başta belediye başkanı Selim olmak üzere şehrin ileri gelenleri onu büyük bir saygıyla karşılar. Ancak bu sıcak karşılamaya rağmen, ilk gününden itibaren bir takım garip ve gergin etkileşimler yaşar. Başlangıçta küçük kasaba siyasetinde taraf olmak istemeyen Emre, yavaş yavaş siyasetin içine çekilir.</h5>
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/kurak-gunler.blade.php ENDPATH**/ ?>