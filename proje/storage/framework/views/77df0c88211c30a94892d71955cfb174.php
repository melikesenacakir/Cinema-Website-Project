        ...
        <div class="row ">
            <div class="col-md-3 mt-4">
                <div class="card custom-card">
                    <a href="/hizliof" style="text-decoration: none;">
            ...
            <div class="col-md-3 mt-4">
                <div class="card custom-card">
                    <a href="/galaksi" style="text-decoration: none;">
            ...
            <div class="col-md-3 mt-4">
                <div class="card custom-card">
                    <a href="/araf" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col-md-3 mt-5">
                <div class="card custom-card">
                    <a href="/neseli" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col-md-3 mt-5">
                <div class="card custom-card">
                    <a href="/mannu" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col-md-3 mt-5">
                <div class="card custom-card">
                    <a href="/kotu" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col-md-3 mt-5">
                <div class="card custom-card">
                    <a href="/askin" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col-md-3 mt-5">
                <div class="card custom-card">
                    <a href="/resmiyaris" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col-md-3 mt-5">
                <div class="card custom-card">
                    <a href="/dali" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
            ...
            <div class="col-md-3 mt-5">
                <div class="card custom-card">
                    <a href="/korsaj" style="text-decoration: none;"> <!-- Update the href attribute to the PHP page -->
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/index.blade.php ENDPATH**/ ?>