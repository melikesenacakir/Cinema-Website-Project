...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="/Resimler/korsaj-.jpg" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">KORSAJ</h1>
                    <h6 class="card-text">15 Mayıs 2023 Pazartesi</h6>
                    <h6 class="card-text">Yönetmen: Marie Kreutzer</h6>
                    <h6 class="card-text">Oyuncular: Vicky Krieps, Colin Morgan, Florian Teichtmeister</h6>
                    <h6 class="card-text">Süre:113 dakika</h6>
...
<?php /**PATH C:\xampp\htdocs\proje\resources\views/project/filmler/korsaj.blade.php ENDPATH**/ ?>