...
<div class="card" style="">
    <div class="row no-gutters">
        <div class="col-md-4">
            <img src="../Resimler/galaksininkoruyuculari3.png" class="card-img" alt="..." style="width: 400px; height: 450px;">
        </div>
        <div class="col-md-8">
            <div class="card-body d-flex flex-column justify-content-between">
                <div>
                    <h1 class="card-title">GALAKSİNİN KORUYUCULARI 3</h1>
                    <h6 class="card-text">5 Mayıs 2023 Cuma</h6>
                    <h6 class="card-text">Yönetmen: James Gunn</h6>
                    <h6 class="card-text">Oyuncular: Karen Gillian, Elizabeth Debicki</h6>
                    <h6 class="card-text">Süre:149 dakika</h6>
    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <h5 class="card-text">Peter Quill (Chris Pratt), hâlâ korkunç bir kaybın etkisindedir, ekibini toplayıp evreni savunmak ve Rocket'ı korumak için zorlu, aksiyon dolu bir göreve atılmalıdır. Bu arada, yeni, öngörülemez bir güç, Koruyucuları sonsuza dek yok etmekle tehdit eder.</h5>
            </div>
        </div>
    </div>
</div>
